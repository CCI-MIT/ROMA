...
* Time: 12:52 PM
*/
public class DelegatingSim extends DefaultServerSimulation {

    public DefaultServerSimulation delegate;

    public DelegatingSim(DefaultServerSimulation delegate) {
