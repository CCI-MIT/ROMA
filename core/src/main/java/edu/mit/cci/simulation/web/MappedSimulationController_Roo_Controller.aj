...
privileged aspect MappedSimulationController_Roo_Controller {
    ...
    public String MappedSimulationController.create(@Valid  MappedServerSimulation mappedSimulation, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
    ...
    public String MappedSimulationController.update(@Valid  MappedServerSimulation mappedSimulation, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
            model.addAttribute("mappedSimulation", mappedSimulation);
            addDateTimeFormatPatterns(model);
    ...
    public Collection<DefaultServerSimulation> MappedSimulationController.populateDefaultSimulations() {
