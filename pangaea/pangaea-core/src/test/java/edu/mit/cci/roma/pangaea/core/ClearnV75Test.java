...
public class ClearnV75Test {
	
	@Test
	public void calculateBaseline() throws PangaeaException, VensimException {
		VensimModelDefinition def = PangaeaPropsUtils.getModelForName("clearn_v75");
		...
		params.put("Global emissions by Year[2090]", "1");
		params.put("Global emissions by Year[2100]", "100000");
