...
public class CreateSimulations {
    ...
    public DefaultServerSimulation findOrCreate(String namefragment) {
        List<DefaultServerSimulation> existing = DefaultServerSimulation.findAllDefaultServerSimulations();
        for (DefaultServerSimulation sim : existing) {
    ...
    public void createOld760() throws IOException, ParseException, SimulationCreationException {
        ...
        DefaultServerSimulation pangaea = findOrCreate("C-LEARN");
        DefaultServerSimulation damage = findOrCreate("damage costs");
        DefaultServerSimulation tyndall_m = findOrCreate("tyndall_m");
        DefaultServerSimulation ipcc_m = findOrCreate("ipcc_m");
        DefaultServerSimulation mitigation = createOldMitigation();
        ...
        */
        ...
        // add mapping for 3 region composite roma
    ...
    public void createAll() throws IOException, ParseException, SimulationCreationException {
        ...
        DefaultServerSimulation damage = createDamage();
        DefaultServerSimulation mitigation = createEMF22Mitigation();
        DefaultServerSimulation tyndall = createTyndall();
        DefaultServerSimulation ipcc = createIPCC();
        DefaultServerSimulation disag7 = create7RegionDisagregation();
        DefaultServerSimulation disag15 = create15RegionDisagregation();


        MappedServerSimulation tyndall_m = new MappedServerSimulation();
        ...
        MappedServerSimulation ipcc_m = new MappedServerSimulation();
        ...
        */
        ...
        CompositeServerSimulation csim_7reg = new CompositeServerSimulation();
        ...
        /* Mapping from input variables to input variables of disag7 roma */
        ...
        */
        ...
        CompositeServerSimulation csim_15reg = new CompositeServerSimulation();
        ...
        /* Mapping from input variables to input variables of disag15 roma */
...
//    @Transactional
//    @Rollback(false)
    public DefaultServerSimulation createPangaea() throws IOException, ParseException {
        ...
        return (DefaultServerSimulation) sim;
    }

    //    @Test
//    @Transactional
//    @Rollback(false)
    public DefaultServerSimulation createEMF22Mitigation() throws IOException, ParseException {
        DefaultServerSimulation sim = (DefaultServerSimulation) createBaseSim("./target/test-classes/emf22_mitigation", 101, 11);
...
//    @Rollback(false)
 ...
 @Rollback(false)
    public void createDOEModel() throws IOException, ParseException {
        ...
        DefaultServerSimulation sim = (DefaultServerSimulation)createBaseSimNewFormat("./target/test-classes/doe_model");
...
//    @Rollback(false)
    ...
    private DefaultServerSimulation create15RegionDisagregation() throws IOException, ParseException {
    ...
    private DefaultServerSimulation create7RegionDisagregation() throws IOException, ParseException {
