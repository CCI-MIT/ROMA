...
public class CreateSimulationClearnv75 {
	...
	public void createPangaea() throws IOException, ParseException {
        Simulation sim = createBaseSim("/tmp/pangaeaEnroads/clearn_v75", 1, 21);
        sim.setUrl("http://localhost:8886/pangaea-servlet/rest/run/clearn_v75");
