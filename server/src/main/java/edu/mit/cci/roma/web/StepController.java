...
public class StepController {
    ...
    public String create(@Valid Step step, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
    ...
    public String update(@Valid Step step, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
            model.addAttribute("step", step);
            return "steps/update";
        }
