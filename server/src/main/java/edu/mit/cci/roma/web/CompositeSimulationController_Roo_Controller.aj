...
privileged aspect CompositeSimulationController_Roo_Controller {
    ...
    public String CompositeSimulationController.create(@Valid CompositeServerSimulation compositeSimulation, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
    ...
    public String CompositeSimulationController.update(@Valid CompositeServerSimulation compositeSimulation, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
            model.addAttribute("compositeSimulation", compositeSimulation);
            addDateTimeFormatPatterns(model);
