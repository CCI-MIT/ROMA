 ...
 * Time: 4:23 PM
 */
public class AdaptedSimulation extends AdaptedObject<edu.mit.cci.roma.api.Simulation> implements Simulation {
    ...
    public AdaptedSimulation(edu.mit.cci.roma.api.Simulation o, RepositoryManager manager) {
        super(o,manager);
