...
public class AdaptedTuple implements Tuple {
    ...
    public AdaptedTuple(edu.mit.cci.simulation.impl.Tuple[] tuples,int index) {
    ...
    private static TupleStatus transform(edu.mit.cci.simulation.api.TupleStatus status) {
