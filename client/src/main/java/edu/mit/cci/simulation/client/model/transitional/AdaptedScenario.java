 ...
 * Time: 4:31 PM
 */
public class AdaptedScenario extends AdaptedObject<edu.mit.cci.simulation.api.Scenario> implements Scenario {

    Simulation sim = null;
    List<Variable> inputs = null;
    List<Variable> outputs = null;

    public AdaptedScenario(edu.mit.cci.simulation.api.Scenario o, RepositoryManager manager) {
        super(o,manager);
    }
    ...
    private static void filterTuples(Set<Tuple> vals, Set<edu.mit.cci.simulation.api.Variable> vars) {
    ...
    private List<Variable> processTupleList(Set<Tuple> tuples) {
